...
async def help(client, message):
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("Islamic Group👳‍♂️", url="https://t.me/islamicsongsmadhsongs"),
                    InlineKeyboardButton("About Me", callback_data="about_data")
                ],
                [
                    InlineKeyboardButton("Channel", url="https://t.me/hd_designer_p"),
                    InlineKeyboardButton("Support Group", url="https://t.me/joinchat/xRQO-i85mixjYmNl")
                ]
            ]
        ),
        reply_to_message_id=message.message_id
            ...
            [
                [
                    InlineKeyboardButton(
                        "SOURCE CODE", url="https://t.me/hd_designer_p/3")
                ],
                [
